...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <div className="relative w-full pt-[76px] sm:pt-[98px]">
      <div className="fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-md z-50 flex flex-row items-center justify-between w-full sm:p-[12px] p-[8px] border-b border-gray-200/50 shadow-sm">
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <a
              href="#"
              className="text-gray-900 font-medium pb-1 relative group"
            >
              Dashboard
            ...
            <a
              href="#"
              className="text-gray-600 hover:text-gray-900 font-medium relative group transition-colors duration-200"
            >
              Campaigns
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <img
                src={Avatar}
                alt="user avatar"
                className="sm:h-[44px] h-[38px] w-auto"
              />
            </div>
          </div>
        )}
